                ...
                <div class="mt-5">
                    <form method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="text" name="author" class="form-control" autofocus id="author" aria-describedby="emailHelp" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="blog_title" class="form-control" id="blog_title" aria-describedby="emailHelp" required>
                            <div id="emailHelp" class="form-text">Vui lòng không nhập kí tự đặc biệt</div>
                        </div>

                        <div class="mb-3">
                            <label for="blog_image" class="form-label">Ảnh bài viết</label>
                            <input type="file" name="blog_image" class="form-control" id="blog_image" aria-describedby="emailHelp" required>
                        </div>

                        <div class="mb-3">
                            <label for="blog_content" class="form-label">Nội dung</label>

                            <textarea required id="editor" name="blog_content"></textarea>
                        </div>

                        <button name="submit" type="submit" class="btn btn-success">Xuất bản</button>
                    </form>
                </div>
            </div>
        </div>
