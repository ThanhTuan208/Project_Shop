                        ...
                        <div class="widget-content nopadding mt-3">
                            <table class="table table-bordered table-striped table-hover">
                                <thead class="table-dark text-center">
                                    <tr>
                                        <th style="width: 20vh;">Tên</th>
                                        <th style="width: 20vh;">Nhà Sản Xuất</th>
                                        <th style="width: 10vh;">Loại</th>
                                        <th style="width: 10vh;">Giá</th>
                                        <th style="width: 20vh;">Hình Ảnh</th>
                                        <th style="width: 40vh;">Mô Tả</th>
                                        <th>Nổi Bật</th>
                                        <th>Ngày Tạo</th>
                                        <th>Thao Tác</th>
                                    </tr>
