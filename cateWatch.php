...
<body>
    ...
    <div class="page-heading about-heading header-text"
        style="background-image: url(https://th.bing.com/th/id/R.8ae0b1ed73077eeb1fedc8443675361e?rik=tG7ecCoAAJuP4Q&pid=ImgRaw&r=0); background-size: cover; background-repeat: no-repeat; background-position: center center; height: 550px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
    ...
    <div class="products">
        <div class="container">
            <div class="row mx-0">
                <?php
                $searchByType_Id = $product->searchByType_Id(5, $start, $perPage);
