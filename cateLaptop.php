...
<body>
    ...
    <div class="page-heading about-heading header-text"
        style="background-image: url(https://i0.wp.com/www.techporn.ph/wp-content/uploads/ASUS-ROG-Laptop-RTX-CES-PR-1.jpg?fit=900%2C507&ssl=1); background-size: cover; background-repeat: no-repeat; background-position: center center; height: 550px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
    ...
    <div class="products">
        <div class="container">
            <div class="row mx-0">
                <?php
                $searchByType_Id = $product->searchByType_Id(2, $start, $perPage);
                    ...
                    <div class="col-md-4">
                        <div class="product-item shadow">
                            ...
                            <img src="anh/<?php echo $value['image']; ?>" alt=""
                                style="width: 330px; height: 200px; object-fit: cover; display: block; margin: auto;">
