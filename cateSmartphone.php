...
<body>
    ...
    <div class="page-heading about-heading header-text"
        style="background-image: url(https://img.freepik.com/free-vector/electronics-store-landing-page-template_52683-155975.jpg?t=st=1734407462~exp=1734411062~hmac=b3d54b9e3ea5c47a55b4545522950cc098413e8a3a4a8ac2f46341cbb49e216a&w=1060); background-size: cover; background-repeat: no-repeat; background-position: center center; height: 550px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="product-item shadow">
                            <a href="product-details.php?id=<?php echo $value['id'] ?>"><img
                                    ...
                                    style="width: 300px; height: 400px; object-fit: cover; display: block; margin: auto;"></a>
